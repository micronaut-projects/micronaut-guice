...
We have a [template repo](https://github.com/micronaut-projects/micronaut-guice) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-guice/blob/master/.github/workflows/release.yml)
